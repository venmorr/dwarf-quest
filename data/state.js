...
{ state: 5, //put on some tea 1
  ...
  otherFx: null,
  confetti: false,
  text: 'The smell of a struck match, the sound of the kettle boiling, the satisfaction of tea leaves unfurling as they steep. Few things in life are better than a good cup of tea. Now then, what next?',
...
{ state: 7, //put on some tea 2
  ...
  otherFx: null,
  confetti: false,
  text: 'The smell of a struck match, the sound of the kettle boiling, the satisfaction of tea leaves unfurling as they steep. Few things in life are better than a good cup of tea. Now then, finally it is time to...',
  choices: ['Pet Méowyn', null, null, null], 
  nextState: [8, null, null, null],
},
...
{ state: 40, 
  ...
  otherFx: null,
  confetti: false,
  text: 'As you reach the tree line the dark expance of forest ahead of you pertrifies you with its vast multitude of dark corners for creatures to hide in. Few return from the dark woods and those who do tell tales of witches, ghouls, and worse. But if Phantom Me',
...
{ state: null, //template for making new states
  name: 'null',
  image: 'null',
  soundFx: '', 
  otherFx: null,
